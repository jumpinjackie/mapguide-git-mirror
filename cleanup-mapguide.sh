...
java -jar ../../bfg.jar --protect-blobs-from master,3.1 --delete-folders {Maestro,MgDev/Oem/dbxml/db-4.8.26/docs,MgDev/Oem/dbxml/dbxml/docs,MgDev/Oem/dbxml/xqilla/docs,MgDev/Oem/dbxml/xerces-c-src/doc} --strip-blobs-bigger-than 12M --private
